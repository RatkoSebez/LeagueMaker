...
import com.lgm.demo.model.converter.LongListConverter;
...
public class User implements UserDetails {
    ...
    public User(String username, String email, String password, String name, String surname, Set<Role> roles) {
        this.username = username;
        this.email = email;
        this.password = password;
        this.name = name;
